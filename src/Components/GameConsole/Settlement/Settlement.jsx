    ...
    return (
      <Fragment>
        <div className='settlement-console'>
          ...
          {((this.props.settlement.farming.effect*this.props.settlement.farming.multiplier*this.props.settlement.farming.num)+(this.props.settlement.meadows.effect*this.props.settlement.meadows.multiplier*this.props.settlement.meadows.num)+(this.props.settlement.fishing.effect*this.props.settlement.fishing.multiplier*this.props.settlement.fishing.num)-this.props.settlement.population.number
< 0) ? <Starvation /> : ''}
          <HighRisk />
          <LowFood />
